## Localhost server with Python3
1. `python3 -m http.server`
2. Open your browser and go to http://localhost:8000


## Todos
1. Add slider using new CSS scroll-marker / button property - https://chrome.dev/css-wrapped-2025/#scroll-marker-button
...
### Marketing / Visibility improvements
